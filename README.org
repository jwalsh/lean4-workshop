...
[[file:docs/demo/euler-screenshot.png]]

~bin/l4w-emacs~ on [[file:scratch/Euler.lean][scratch/Euler.lean]], LSP connected, scrolled to a
chosen ~#eval~ line; see [[file:docs/demo/README.org][docs/demo/]] for how it was captured and how
to make a fresh one.
